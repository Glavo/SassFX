...
package org.glavo.scssfx.internal.repl;
...
import org.glavo.scssfx.internal.parse.SassScriptParser;
...
public final class SassInteractiveSession {
    ...
    public SassInteractiveSession(
        ...
        this.baseUrl = directory.resolve(".scssfx-repl.scss").toUri();
    }
    ...
    private SassCompilationException failure(
            Diagnostic primary,
            @Unmodifiable List<? extends org.glavo.scssfx.SassStackFrame> trace,
            Throwable cause
    ) {
