...
/// its compile classpath contains neither JavaFX nor SCSSFX product classes.
@NotNullByDefault
public final class JavaFx8OracleHelper {
    ...
    /// Generates JavaFX 8 BSS, compares it with SCSSFX, and loads the result.
    ///
    ...
    public static void main(String[] arguments) throws Exception {
        ...
        if (loaded == null) {
            throw new AssertionError("JavaFX 8 returned null when loading SCSSFX BSS.");
        }
    }
