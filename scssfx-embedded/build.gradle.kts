...
application {
    mainClass = "org.glavo.scssfx.embedded.ScssfxEmbeddedMain"
}
...
tasks.jar {
    ...
    manifest {
        attributes(
            "Automatic-Module-Name" to "org.glavo.scssfx.embedded",
...
tasks.shadowJar {
    ...
    relocate(
        "com.google.protobuf",
        "org.glavo.scssfx.internal.thirdparty.protobuf",
    )
    relocate(
...
val verifyShadedJar = tasks.register("verifyShadedJar") {
    ...
    doLast {
        ...
        val requiredEntries = listOf(
            "org/glavo/scssfx/embedded/ScssfxEmbeddedMain.class",
